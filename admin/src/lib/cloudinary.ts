// Cloudinary direct unsigned upload (browser). URLs saved in Supabase.
...
export async function uploadToCloudinary(file: File, folder = 'catering_app/admin'): Promise<string> {
