        ...
        <div className="grid gap-4 md:grid-cols-4 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {stats?.pendingBookings || 0} pending · {stats?.acceptedBookings || 0} accepted · {stats?.completedBookings || 0} completed · {stats?.declinedBookings || 0} declined · {stats?.cancelledBookings || 0} cancelled
              </p>
            </CardContent>
          </Card>
