...
import { Search, ArrowRight, Star, Users, Calendar, Award, Loader2 } from 'lucide-react';
...
export default function Home() {
  ...
  const { data: caterers = [], isLoading } = useApprovedCaterers();

  // Get first 3 caterers for featured section
        ...
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16 text-muted-foreground">
              No caterers available yet. Check back soon!
            </div>
          ) : (
