...
export const getCatererById = (_id: string): Caterer | undefined => {
  return undefined;
};
...
export const getMenuItemsByCaterer = (_catererId: string): MenuItem[] => {
  return [];
};

export const getReviewsByCaterer = (_catererId: string): Review[] => {
  return [];
};

export const getBookingsByCustomer = (_customerId: string): Booking[] => {
  return [];
};

export const getBookingsByCaterer = (_catererId: string): Booking[] => {
  return [];
};
